...
from cdcs.domain.models import Parameter, Signature
from cdcs.language.typescript._runtime import (
    TypeScriptRuntimeError,
    call_parse_source,
)
from cdcs.parsing.source_parser import ParsedFunction, ParsedSource
...
class TypeScriptSourceParser:
    ...
    :class:`~cdcs.parsing.dsl_parser.DSLParser`.
    """
