...
from cdcs_mini.domain.models import Parameter

if TYPE_CHECKING:
    from cdcs_mini.parsing.source_parser import ParsedSource
    from cdcs_mini.synthesis.prompt import LanguageProfile
...
class LanguageAdapter(Protocol):
    ...
    def prompt_profile(self) -> LanguageProfile:
        ...
        See :class:`cdcs_mini.synthesis.prompt.LanguageProfile`. The
