    ...
    <header className="border-b border-slate-200/80 bg-white/70 backdrop-blur dark:border-white/5 dark:bg-slate-950/70">
      <div className="mx-auto flex h-14 max-w-7xl items-center justify-between px-6">
        <a href="/" className="flex items-center gap-2.5 group">
          ...
          />
          <span className="bg-gradient-to-r from-indigo-700 via-violet-600 to-blue-600 bg-clip-text text-base font-semibold tracking-tight text-transparent dark:from-indigo-200 dark:via-violet-300 dark:to-blue-300">
            CDCS Mini
          </span>
        ...
        <nav className="flex items-center gap-1 text-sm text-slate-600 dark:text-slate-300">
          ...
          <a
            ...
            className="ml-2 inline-flex items-center gap-2 rounded-lg border border-slate-200 bg-white px-3 py-1.5 text-sm font-medium text-slate-700 shadow-sm transition hover:border-slate-300 hover:bg-slate-50 dark:border-white/10 dark:bg-white/5 dark:text-slate-200 dark:shadow-none dark:hover:border-white/20 dark:hover:bg-white/10"
          >
            <GitHubIcon />
            GitHub
          </a>
          <button
            ...
            className="ml-1 inline-flex h-9 w-9 items-center justify-center rounded-lg border border-slate-200 bg-white text-slate-500 transition hover:border-slate-300 hover:text-slate-700 dark:border-white/10 dark:bg-white/5 dark:text-slate-300 dark:hover:border-white/20 dark:hover:text-slate-100"
          >
